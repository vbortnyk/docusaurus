...
### Table of contents
- [Minecraft Server 1.21.4](#minecraft-server-1214)
...
Navigate to our project and rename the file `.env-template`. 
This file contains environment variables with the default values for MAX_USERS and DIFFICULTY.
